module github.com/deepfabric/beevector

go 1.14

require (
	github.com/deepfabric/beehive v0.0.0-20200729015354-2344af6269a9
	...
	github.com/infinivision/vectodb v0.0.0-20200715120254-34cda87eebb9
